 ...
 * ```
 *
 * @property \kawaii\web\AssetManager $assetManager The asset manager. Defaults to the "assetManager" application
 * component.
 *
...
class View extends \kawaii\base\View
{
     ...
     * @return \kawaii\web\AssetManager the asset manager. Defaults to the "assetManager" application component.
     */
     ...
     * @param \kawaii\web\AssetManager $value the asset manager
     */
