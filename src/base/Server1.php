 ...
 * @package kawaii\base
 */
abstract class Server1 extends Object
{
    /**
     * @var ServerListener[]
     */
     ...
     * @return bool
     */
    public function start(ApplicationInterface $app)
    {
...
//        static::$swooleServer->on('Connect', [$this, 'onConnect']);
    ...
    private static function initSwooleServer()
    {
        ...
        static::$swooleServer = new SwooleHttpServer($listener->host, $listener->port);
