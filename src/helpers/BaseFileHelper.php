...
use Kawaii;
use kawaii\base\ErrorException;
...
class BaseFileHelper
{
     ...
     */
    public static $mimeMagicFile = '@kawaii/helpers/mimeTypes.php';
     ...
     * If not set, the value of [[\kawaii\base\Application::language]] will be used.
     * @param string $sourceLanguage the language that the original file is in.
     * If not set, the value of [[\kawaii\base\Application::sourceLanguage]] will be used.
    ...
    {
        if ($language === null) {
            $language = Kawaii::$app->language;
        }
        if ($sourceLanguage === null) {
            $sourceLanguage = Kawaii::$app->sourceLanguage;
        }
    ...
    {
        if ($magicFile !== null) {
            $magicFile = Kawaii::getAlias($magicFile);
        }
     ...
     * @throws \kawaii\base\InvalidParamException if unable to open directory
     */
     ...
     * @throws \kawaii\base\Exception if the directory could not be created (i.e. php error due to parallel changes)
     */
    public static function createDirectory($path, $mode = 0775, $recursive = true)
    {
        ...
        try {
            ...
            if (!is_dir($path)) {// https://github.com/kawaiisoft/kawaii2/issues/9288
                throw new \kawaii\base\Exception("Failed to create directory \"$path\": " . $e->getMessage(), $e->getCode(), $e);
            }
        }
        try {
            return chmod($path, $mode);
        } catch (\Exception $e) {
            throw new \kawaii\base\Exception("Failed to change permissions for directory \"$path\": " . $e->getMessage(), $e->getCode(), $e);
        }
    }
     ...
     * @throws \kawaii\base\InvalidParamException
