...
class Container extends Object
{
    ...
    protected function build($class, $params, $config)
    {
        ...
        if (!empty($dependencies) && $reflection->implementsInterface('kawaii\base\Configurable')) {
     ...
     *    // ...
     * }
     * Kawaii::$container->invoke($formatString, ['string' => 'Hello World!']);
     * ```
     *
    ...
    public function resolveCallableDependencies(callable $callback, $params = [])
    {
        ...
        $associative = true;//ArrayHelper::isAssociative($params); @todo xxxx
