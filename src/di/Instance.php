...
class Instance
{
     ...
     *
     * If you do not specify a container, the method will first try `Kawaii::$app` followed by `Kawaii::$container`.
     *
     * For example,
     *
     * ```php
     ...
     * If null, the method will first try `Kawaii::$app` then `Kawaii::$container`.
    ...
    public function get($container = null)
    {
        ...
        if (Kawaii::$app && Kawaii::$app->hasComponent($this->id)) {
            return Kawaii::$app->getComponent($this->id);
        } else {
            return Kawaii::$container->get($this->id);
        }
    }
}
