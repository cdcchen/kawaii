...
use kawaii\helpers\ArrayHelper;
use kawaii\helpers\Html;
 ...
 *
 * View is configured as an application component in [[\kawaii\base\Application]] by default.
 * You can access that instance via `Kawaii::$app->view`.
 *
 ...
 * ```
 *
 * @property \kawaii\http\AssetManager $assetManager The asset manager. Defaults to the "assetManager" application
 * component.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @since 2.0
 */
class View extends \kawaii\base\View
{
    /**
     ...
     * @return \kawaii\http\AssetManager the asset manager. Defaults to the "assetManager" application component.
     */
    public function getAssetManager()
    {
        return $this->_assetManager ?: Kawaii::$app->getAssetManager();
    }

    /**
     * Sets the asset manager.
     * @param \kawaii\http\AssetManager $value the asset manager
     */
